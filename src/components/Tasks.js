...
const Tasks = ({ todo, todos, setTodos, content, setContent }) => {
  ...
  return (
    <div className="w-full flex justify-center items-center">
      <div className=" bg-[#568CB3] text-white w-3/4 py-3 rounded-md hover:scale-105 hover:shadow-xl duration-200 ease-out ">
        {todo.isEditing ? (
          <Edit
            content={content}
